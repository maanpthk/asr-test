...
def deploy_model():
    ...
    REGION = 'ap-south-1' 
    model_name = "indicasr-odia-model"  
    endpoint_config_name = "indicasr-odia-config"  
    endpoint_name = "indicasr-odia-endpoint"  

    # Container definition
    container = f"{ACCOUNT_ID}.dkr.ecr.{REGION}.amazonaws.com/indicasr-odia:latest"  # Changed from hindi to odia
